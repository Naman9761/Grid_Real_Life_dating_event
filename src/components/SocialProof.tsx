...
export default function SocialProof() {
  return (
    <section className="relative overflow-hidden py-2 md:py-10 px-6">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-brand-pink/10 blur-[120px] rounded-full -z-10" />
      <div className="max-w-6xl mx-auto border-t border-white/5 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            ...
            <div className="flex -space-x-3">
              {avatars.map((src, i) => (
                <img
                  key={i}
                  src={src}
                  className="w-12 h-12 rounded-full border-2 border-brand-dark"
                  alt="user"
          ...
          >
            <div className="flex -space-x-4">
              <img
                src={avatars[2]}
                className="w-14 h-14 rounded-full border-2 border-brand-dark"
                alt="user"
                referrerPolicy="no-referrer"
              />
              <img
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-white/50">average event rating.</p>
            </div>
          </motion.div>
        </div>
      </div>
